...
^1::MoveCurrentWindowToDesktopBackground(1)
^2::MoveCurrentWindowToDesktopBackground(2)
^3::MoveCurrentWindowToDesktopBackground(3)
^4::MoveCurrentWindowToDesktopBackground(4)
